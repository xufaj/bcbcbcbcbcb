...
console.log(`https://discordapp.com/oauth2/authorize?client_id=520651373117964298&permissions=8&scope=botInvite Me To Your Server!`);
    setTimeout(() => {
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setURL(`https://discordapp.com/oauth2/authorize?client_id=520651373117964298&permissions=8&scope=botInvite`);
